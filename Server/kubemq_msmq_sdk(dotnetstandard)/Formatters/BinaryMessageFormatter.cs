...
{
    [Serializable]
    public class BinaryMessageFormatter : MicrosoftFormatter
    {
        ...
        public BinaryMessageFormatter()
        {
            ...
            this.FormatterName = "BinaryMessageFormatter";
        }
        ...
        public object Read(Message message)
        {
            ...
            if (variantType == VT_BINARY_OBJECT)
            {
                Stream stream = KubeMQ.MSMQSDK.SDK.csharp.Helper.BodyStreamConverter.ToBodyStream(message.BodyStream);
        ...
        public void Write(Message message, object obj)
        {
            ...
            message.BodyStream = KubeMQ.MSMQSDK.SDK.csharp.Helper.BodyStreamConverter.FromBodyStream(stream);
        }
    }
}
