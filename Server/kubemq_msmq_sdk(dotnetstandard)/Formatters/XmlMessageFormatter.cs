...
using KubeMQ.MSMQSDK.SDK.csharp.Helper;

namespace KubeMQ.MSMQSDK.Messages
{
    [Serializable]
    public class XmlMessageFormatter : MicrosoftFormatter
    {
        private Type[] targetTypes;
        private string[] targetTypeNames;
        private Hashtable targetSerializerTable = new Hashtable();
        ...
        public XmlMessageFormatter()
        {
            ...
            this.FormatterName = "XmlMessageFormatter";
        }
